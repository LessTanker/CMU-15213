...
| 检查数据<br/>    print $rax<br/>    print /x $rip <br/>    x/2g 0x7fffffffe818<br/>    x/s 0x402400 | <br/>以十进制输出%rax的内容<br/>以十六进制输出程序计数器的值<br/>检查从地址0x7fffffffe818开始的双字<br/>以字符串形式打印地址0x402400的内容 |
