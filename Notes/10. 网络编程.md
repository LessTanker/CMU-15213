...
IP地址就是一个32位无符号整数，网络程序将IP存放在下面这个结构体中。
...
本人于2025.11.1完成这一章课本上的内容，感觉并不难懂，把lab做完应该就问题不大。这章进度这么快的原因是本人于2025暑假第一次学习的时候整理过此章的笔记，当时也没有做lab，现在就补个票。